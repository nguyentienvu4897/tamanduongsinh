	...
	public function update(Request $request)
	{
		$validate = Validator::make(
			...
			[
                ...
                'about_image' => 'nullable|file|mimes:jpg,jpeg,png|max:3000',
                'location' => 'nullable'
			]
		);
		...
		try {
            ...
            if($request->about_image) {
                if($object->about_image) {
                    FileHelper::forceDeleteFiles($object->about_image->id, $object->id, ThisModel::class, 'about_image');
                }
                FileHelper::uploadFile($request->about_image, 'configs', $object->id, ThisModel::class, 'about_image',99);
            }
