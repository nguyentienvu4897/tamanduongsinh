...
@section('page_title')
Quản lý khối nội dung trang Showroom
@endsection
...
<div ng-cloak>
    <div class="row" ng-controller="Banners">
        ...
        {{-- Form tạo mới --}}
        @include('admin.showrooms.create')
        @include('admin.showrooms.edit')
...
@section('script')
@include('admin.showrooms.Showroom')
...
<script>
    app.controller('Banners', function ($rootScope, $scope, $http) {
        ...
        function updateBlockOrder(oldIndex, newIndex) {
            ...
            $.ajax({
                type: 'POST',
                url: "{!! route('showrooms.updateOrderShowroom') !!}",
                headers: {
        ...
        $scope.editBlock = function (blockId) {
            $.ajax({
                type: 'GET',
                url: "/admin/showrooms/" + blockId + "/getDataForEdit",
                headers: {
                    'X-CSRF-TOKEN': CSRF_TOKEN
                },
                data: blockId,
